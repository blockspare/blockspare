<?php
    ...
    if (!function_exists('blockspare_create_gutens_block')) {
        
        
        function blockspare_create_gutens_block()
        {
        ...
        add_action('enqueue_block_editor_assets', 'blockspare_create_gutens_block');
