    ...
    n.SkillBar = function () {
        ...
        n.Tabs = function(){
            ...
            $('.blockspare-tab-title').on('click', function (event) {
                ...
                if ($blockspareTab.hasClass('blockspare-active')) {
                    var tab_bg = $(this).attr('tab-bg');
                    var text = $(this).attr('tab-text');
                    $('.blockspare-tab-item').find('.blockspare-tab-title ').css('background-color', tab_bg);
                    $('.blockspare-tab-item').find('.blockspare-tab-title ').css('color', text);

                    var tab_abg = $(this).attr('atab-bg');
                    var atext = $(this).attr('atab-text');
        ...
        n.Accordion = function(){
            $('.blockspare-block-accordion:not(.blockspare-accordion-ready)').each(function () {
                ...
                $accordion.on('click', '.blockspare-accordion-item .blockspare-accordion-panel', function (e) {
                    ...
                    var _pnl = $('.blockspare-type-fill').attr('data-pan');
                    var text_pnl = $('.blockspare-type-fill').attr('data-txt-color');
                    ...
                    if (isActive) {
                        ...
                        var act_pnl_text= $('.blockspare-type-fill').attr('data-act-color');
                        console.log(act_pnl_text);
                        var act_pnl = $('.blockspare-type-fill').attr('data-active');
